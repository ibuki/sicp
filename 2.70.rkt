...
(define (encode-symbol symbol tree)
  ...
  (define (encode-symbol-1 bits current-tree)
    (cond
      [(equal? (list symbol) (symbols (left-branch current-tree))) (append bits '(0))]
...
; (make-leaf-set '((A 4) (B 2) (C 1) (D 1)))
(define sample-tree2 (generate-huffman-tree '((A 4) (B 2) (C 1) (D 1))))
; (make-leaf-set '((A 4) (B 2) (C 1) (D 1)))
; (define sample-tree2 (make-code-tree-from-leaf-set (make-leaf-set '((A 4) (B 2) (C 1) (D 1)))))
...
(encode '(A B C D) sample-tree2)

'((A 2) (GET 2) (SHA 3) (WAH 1) (BOOM 1) (JOB 2) (NA 16) (YIP 9))
(define sample-tree3 (generate-huffman-tree '((A 2) (GET 2) (SHA 3) (WAH 1) (BOOM 1) (JOB 2) (NA 16) (YIP 9))))
sample-tree3
...
(define lyrics
  '(GET A
        ...
        SHA
        BOOM))
(encode lyrics sample-tree3)
(length lyrics)
(length (encode lyrics sample-tree3))

(decode (encode lyrics sample-tree3) sample-tree3)
